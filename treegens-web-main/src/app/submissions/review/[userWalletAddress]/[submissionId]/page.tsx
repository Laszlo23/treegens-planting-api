...
import VerifierReviewSubmissionPageClient from './VerifierReviewSubmissionPageClient'
...
export default function VerifierReviewSubmissionPage() {
  return <VerifierReviewSubmissionPageClient />
}
